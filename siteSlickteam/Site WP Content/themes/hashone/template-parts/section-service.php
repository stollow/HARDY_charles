...
<section id="hs-service-post-section" class="hs-section">
	...
	<div class="hs-container">
		<div class="hs-service-posts">
			...
			<h2 class="hs-section-title"><?php echo esc_html($hashone_service_title); ?></h2>
			<?php } ?>

			<?php if($hashone_service_sub_title){ ?>
			<div class="hs-section-tagline"><?php echo esc_html($hashone_service_sub_title); ?></div>
			<?php } ?>
			...
			<div class="hs-service-post-wrap">
				...
				for( $i = 1; $i < 7; $i++ ){
					...
					if($hashone_service_page_id){
						...
						?>
							<div class="hs-clearfix hs-service-post hs-service-post<?php echo $i; ?>">
								...
								<div class="hs-service-excerpt">
									...
									<?php 
										if(has_excerpt()){
											...
											echo hashone_excerpt( get_the_content(), 500);
										}
									 ?>
								</div>
							</div>
