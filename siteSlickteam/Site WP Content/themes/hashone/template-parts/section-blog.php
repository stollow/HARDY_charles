...
<section id="hs-blog-section" class="hs-section">
	<div class="hs-container">
		...
		<h2 class="hs-section-title-white wow fadeInUp" data-wow-duration="0.5s"><?php echo esc_html($hashone_blog_title); ?></h2>
		<?php } ?>

		<?php if($hashone_blog_sub_title){ ?>
		<div class="hs-section-tagline-white wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s"><?php echo esc_html($hashone_blog_sub_title); ?></div>
		<?php } ?>
