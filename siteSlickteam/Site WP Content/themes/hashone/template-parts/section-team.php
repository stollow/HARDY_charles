...
<section id="hs-team-section" class="hs-section" align="center">
	<div class="hs-container" align="center"">
		<?php
		...
		<h2 class="hs-section-title"> <?php echo $hashone_team_title; ?></h2>
		<?php } ?>

		<?php if($hashone_team_sub_title){ ?>
		<div class="hs-section-tagline"> <?php echo $hashone_team_sub_title; ?></div>
		<?php } ?>

		<div class="hs-team-member-wrap" align="center">
			<?php 
			for( $i = 1; $i < 3; $i++ ){
					...
					?>
						<div class="hs-team-member">
							...
							<div class="hs-team-member-image">
								<img src="<?php echo ($hashone_image[0]);?>" alt="<?php esc_attr(get_the_title()); ?>" />
